...
class Visualization:
    ...
    def training_save_data_and_plot(self, data, filename, xlabel, ylabel):
        ...
        plt.plot(np.arange(0,episodes), all_averaged,  'k', label = "Dynamic scenarios with rolling average")
        ...
        plt.plot(np.arange(0,episodes), data,  'k', label = "Dynamic scenarios without rolling average")
