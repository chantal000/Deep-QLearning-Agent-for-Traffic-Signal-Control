...
def import_train_configuration(config_file):
    ...
    config['greedy_episode_every_x_steps'] = content['simulation'].getint('greedy_episode_every_x_steps')
...
def import_test_configuration(config_file):
    ...
    config['total_episodes'] = content['simulation'].getint('total_episodes_to_test')
    config['num_actions'] = content['agent'].getint('num_actions')
    config['sumocfg_file_name'] = content['dir']['sumocfg_file_name']
    config['models_path_name'] = content['dir']['models_path_name']
...
def set_test_path(models_path_name, model_n, scenario_number):
    """
    ...
    if os.path.isdir(model_folder_path):    
        plot_path = os.path.join(model_folder_path, 'test_scenario_'+str(scenario_number), '')
